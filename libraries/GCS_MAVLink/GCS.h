...
protected:
    ...
    MAV_RESULT handle_command_force_position_reset(const mavlink_command_int_t &packet);
    MAV_RESULT handle_command_force_wind_reset(const mavlink_command_int_t &packet);
#endif
